...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { hourinterval: @hour.hourinterval, room_id: @hour.room_id } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { hourinterval: @hour.hourinterval, room_id: @hour.room_id } }
