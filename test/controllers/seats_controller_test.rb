...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { hour_id: @seat.hour_id, number: @seat.number, room_id: @seat.room_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { hour_id: @seat.hour_id, number: @seat.number, room_id: @seat.room_id } }
